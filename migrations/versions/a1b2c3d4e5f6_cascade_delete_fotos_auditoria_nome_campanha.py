...
Alterações:
- Adiciona ON DELETE CASCADE na FK turno_id de fotos_auditoria
- Adiciona coluna nome_campanha em acoes_promocionais
"""
...
def upgrade():
    ...
    with op.batch_alter_table('fotos_auditoria', schema=None) as batch_op:
        batch_op.drop_constraint('fotos_auditoria_turno_id_fkey', type_='foreignkey')
